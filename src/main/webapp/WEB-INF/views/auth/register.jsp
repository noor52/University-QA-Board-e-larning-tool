				...
				<div class="row">
					...
					<div class="col-lg-5">
						<div class="p-5">
							...
							<form action="${pageContext.request.contextPath }/register" modelAttribute="user" method="POST"class="user">
								<div class="form-group">

									<input type="text" class="form-control form-control-user" name="fullName" placeholder="Full Name">
